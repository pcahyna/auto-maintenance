...
%global mainid c9e63152c966d8809fc4c1be24af2748e8889a55
...
for role in %{rolename0} %{rolename1} %{rolename2} \
    ...
    %{rolename13}; do
    python3 lsr_role2collection.py --role %{roleprefix}"$role" --src-path "$role" --dest-path .collections --namespace %{collection_namespace} --collection %{collection_name}
done
